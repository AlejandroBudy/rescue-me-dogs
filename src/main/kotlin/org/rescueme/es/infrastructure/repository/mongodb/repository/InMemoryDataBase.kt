...
class InMemoryDataBase {
    ...
    val inMemoryDogs: MutableList<DogEntity> = mutableListOf(
            DogEntity(null, UUID.randomUUID().toString(), "Kitty", "Bichon", shelter1),
            DogEntity(null, UUID.randomUUID().toString(), "Donna", "Husky", shelter1),
            DogEntity(null, UUID.randomUUID().toString(), "Brador", "Pitbull", shelter1),
            DogEntity(null, UUID.randomUUID().toString(), "Pitbull", "Pitbull", shelter1),
            DogEntity(null, UUID.randomUUID().toString(), "Ares", "American bully", shelter1),
            DogEntity(null, UUID.randomUUID().toString(), "other", "unknown", shelter2),
            DogEntity(null, UUID.randomUUID().toString(), "Kira", "Labrador", shelter2))
